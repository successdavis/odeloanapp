    ...
    <div class="grid-cols-3 grid">
        <div class="w-64 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex flex-col items-center pb-10">
                <img class="mb-3 w-24 h-24 rounded-full shadow-lg" :src="account.user.avatar_path" alt="Bonnie image">
                <Link :href="'/members/' + account.user.id " class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ account.user.name }}</Link>
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ account.user.mobile }}</span>
