        ...
        <div class="max-w-2xl md:w-full">
            <form @submit.prevent="form.post('/loans/create')">
                ...
                <div class="relative z-0 mb-6 w-full group">
                    <input v-model ="form.repayment_amount" type="number" name="principal_amount" id="principal_amount" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required="">
                    <label for="principal_amount" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                        Repayment Amount</label>
                    <p v-if="form.errors.repayment_amount" class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oh, snapp!</span> {{ form.errors.repayment_amount }}.</p>
                </div>
                ...
                <member-search url="/getusers" title="Collected By"></member-search>

                <p class="text-xs py-2 mb-4">If this is left blank, it will default to today's date</p>
                    <div class="relative z-0 mb-6 w-full group">
